...
-(NSCalendarUnit)CategoryNSCalendarUnit{
    if (IS_IOS7_DEVICE) {
        return (NSYearCalendarUnit| NSMonthCalendarUnit | NSDayCalendarUnit | NSWeekCalendarUnit |  NSHourCalendarUnit | NSMinuteCalendarUnit | NSSecondCalendarUnit | NSWeekdayCalendarUnit | NSWeekdayOrdinalCalendarUnit);
    }else{
        return (NSCalendarUnitYear| NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekOfMonth |  NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond | NSCalendarUnitWeekday | NSCalendarUnitWeekdayOrdinal);
    }
}
...
+(NSString*)messageListStringSiceNow:(NSDate*)date{
    NSString*str = @"";
    ...
    if(time<D_HOUR){
        str = [NSString stringWithFormat:@"%i分钟前",(int)(time/60)<=0?1:(int)(time/60)];
    }else if(time<D_DAY){
        str = [NSString stringWithFormat:@"%i小时前",(int)(time/3600)];
    }else if(time<D_DAY*30){
        str = [NSString stringWithFormat:@"%i天前",(int)(time/D_DAY)];
    }else if(time<D_YEAR){
...
{
	NSDateComponents *components1 = [CURRENT_CALENDAR components:[self CategoryNSCalendarUnit] fromDate:self];
	NSDateComponents *components2 = [CURRENT_CALENDAR components:[self CategoryNSCalendarUnit] fromDate:aDate];
...
{
    NSDateComponents *components = [CURRENT_CALENDAR components:[self CategoryNSCalendarUnit] fromDate:self];
    components.hour = 0;
    components.minute = 0;
    components.second = 0;
...
- (NSDate *) prevMonth{
    ...
    components.minute = 0;
    components.second = 0;
    return [[CURRENT_CALENDAR dateFromComponents:components] dateByAddingDays:-1];
}

- (NSDateComponents *) componentsWithOffsetFromDate: (NSDate *) aDate
{
	NSDateComponents *dTime = [CURRENT_CALENDAR components:[self CategoryNSCalendarUnit] fromDate:aDate toDate:self options:0];
	return dTime;
}
